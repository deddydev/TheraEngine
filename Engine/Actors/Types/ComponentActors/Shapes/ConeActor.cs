    ...
    public class ConeActor : ShapeActor
    {
        ...
        public ConeActor(string name, float radius, float height, Vec3 translation, Rotator rotation, 
            TMaterial material, TRigidBodyConstructionInfo info, int meshSides = 40, bool closeBottom = true) : base(
                ...
                new List<LOD>()
                {
                    new LOD(material, BaseCone.SolidMesh(Vec3.Zero, Vec3.Up, height, radius, meshSides, closeBottom), 0.0f),
                    new LOD(material, BaseCone.SolidMesh(Vec3.Zero, Vec3.Up, height, radius, meshSides / 4 * 3, closeBottom), 0.0f),
                    new LOD(material, BaseCone.SolidMesh(Vec3.Zero, Vec3.Up, height, radius, meshSides / 2, closeBottom), 0.0f),
                    new LOD(material, BaseCone.SolidMesh(Vec3.Zero, Vec3.Up, height, radius, meshSides / 4, closeBottom), 0.0f),
                },
