...
namespace TheraEngine.Animation
{
    ...
    public class TransformKeyCollection : TFileObject
    {
        ...
        /// Uses the defaultTransform for tracks that have no keys.
        /// </summary>
        public unsafe void GetTransform(out Vec3 translation, out Quat rotation, out Vec3 scale)
        {
        ...
        /// Uses the defaultTransform for tracks that have no keys.
        /// </summary>
        public unsafe void GetTransform(out Vec3 translation, out Quat rotation, out Vec3 scale, float second)
        {
            translation = new Vec3(
        ...
        /// Retrieves the transform at the current frame second.
        /// </summary>
        public unsafe (Vec3 translation, Quat rotation, Vec3 scale) GetTransformParts()
        {
            GetTransform(out Vec3 t, out Quat r, out Vec3 s);
            return (t, r, s);
        }
        ...
        /// Retrieves the transform at the requested frame second.
        /// </summary>
        public unsafe (Vec3 translation, Quat rotation, Vec3 scale) GetTransformParts(float second)
        {
            GetTransform(out Vec3 t, out Quat r, out Vec3 s, second);
            return (t, r, s);
        }
