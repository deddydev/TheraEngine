...
namespace TheraEngine.Components.Scene
{
    ...
    public class VRComponent : OriginRebasableComponent, IEditorPreviewIconRenderable
    {
        public VRComponent()
        {
            LeftEye.OwningComponent = this;
            LeftEye.TransformChanged += RecalcLocalTransform;
        }

        public PerspectiveCamera LeftEye { get; } = new PerspectiveCamera();
        public PerspectiveCamera RightEye { get; } = new PerspectiveCamera();
