...
namespace TheraEngine.Components.Scene.Shapes
{
    public class ConeZComponent : CommonShape3DComponent<ConeZ>
    {
        ...
        public ConeZComponent(Transform transform)
            : base(new ConeZ(transform, 1.0f, 1.0f)) { }

        public ConeZComponent(Transform transform, float radius, float halfHeight)
            : base(new ConeZ(transform, radius, halfHeight)) { }

        public ConeZComponent(Transform transform, float radius, float halfHeight, TRigidBodyConstructionInfo info)
