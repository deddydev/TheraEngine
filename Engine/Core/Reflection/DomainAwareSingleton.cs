...
{
    /// <summary>
    /// A domain-aware singleton. 
    /// Only one instance of <typeparamref name="T"/> will exist, belonging to the default AppDomain.
    ...
    public static class Singleton<T> where T : MarshalByRefObject, new()
    {
        ...
        /// </summary>
        private static string Name => "BA9A49C7E9364060AC4E4DDDBF465684." + typeof(T).FullName;
        ...
        /// </summary>
        public static T Instance => LazyInstance.Value.WrappedInstance;
