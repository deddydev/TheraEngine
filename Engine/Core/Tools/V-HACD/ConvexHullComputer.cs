    ...
    while (true)
    {
        ...
        else
        {
            ...
            if ((cmp >= 0) && e1)
            {
                if (toPrev1)
                {
                    for (Edge* e = toPrev1->next, *n = NULL; e != min1;
                    e = n) {
                        n = e->next;
                        removeEdgePair(e);
                    }
            ...
            if ((cmp <= 0) && e0)
            {
                if (toPrev0)
                {
                    for (Edge* e = toPrev0->prev, *n = NULL; e != min0;
                    e = n) {
                        n = e->prev;
                        removeEdgePair(e);
                    }
        ...
        if ((c0 == first0) && (c1 == first1))
        {
            ...
            {
                for (Edge* e = toPrev0->prev, *n = NULL; e != firstNew0;
                e = n) {
                    n = e->prev;
                    removeEdgePair(e);
                }
            ...
            {
                for (Edge* e = toPrev1->next, *n = NULL; e != firstNew1;
                e = n) {
                    n = e->next;
                    removeEdgePair(e);
                }
