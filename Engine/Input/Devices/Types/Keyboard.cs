...
namespace TheraEngine.Input.Devices
{
    ...
    public abstract class BaseKeyboard : InputDevice
    {
        ...
        public override EDeviceType DeviceType => EDeviceType.Keyboard;
        ...
        public void RegisterKeyPressed(EKey key, EInputPauseType pauseType, DelButtonState func, bool unregister)
        {
            if (unregister)
            {
                ...
                FindOrCacheKey(key)?.RegisterPressedState(func, pauseType, false);
        }
        public void RegisterKeyEvent(EKey key, EButtonInputType type, EInputPauseType pauseType, Action func, bool unregister)
            => RegisterButtonEvent(unregister ? _buttonStates[(int)key] : FindOrCacheKey(key), type, pauseType, func, unregister);
