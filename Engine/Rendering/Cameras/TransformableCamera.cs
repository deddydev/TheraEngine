...
namespace TheraEngine.Rendering.Cameras
{
    ...
    public abstract class TransformableCamera : Camera, ICameraTransformable
    {
        ...
        {
            cameraToWorldSpaceMatrix = Matrix4.CreateTranslation(_localPoint.Value) * _localRotation.GetMatrix();
            worldToCameraSpaceMatrix = _localRotation.GetInverseMatrix() * Matrix4.CreateTranslation(-_localPoint.Value);
        }
