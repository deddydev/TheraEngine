...
namespace CustomEngine.Rendering.Models.Materials
{
    ...
    public class FuncValueInput<TOutput, TParent> : BaseFuncArg<TOutput>, IFuncValueInput
        where TOutput : class, IFuncValueOutput where TParent : class, IFunction
    {
        ...
        public FuncValueInput(string name, TOutput linkedMultiArg)
            : base(name)
        {
            _syncedArgs.Add(linkedMultiArg);
            _allowedArgTypes = linkedMultiArg.AllowedArgumentTypes;
        }
        public FuncValueInput(string name, TParent parent, TOutput linkedMultiArg)
            : base(name, parent)
        {
            _syncedArgs.Add(linkedMultiArg);
            _allowedArgTypes = linkedMultiArg.AllowedArgumentTypes;
