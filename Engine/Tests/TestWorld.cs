...
namespace TheraEngine.Tests
{
    public class TestWorld : World
    {
        public override async void BeginPlay()
        {
            ...
            {
                InitialTransform = new Transform(Vec3.Zero, Quat.Identity, 0.1f, ETransformOrder.TRS),
            ...
            {
                InitialTransform = new Transform(Vec3.Zero, Quat.Identity, new Vec3(1.0f), ETransformOrder.TRS),
            };
