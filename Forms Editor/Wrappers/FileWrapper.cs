...
namespace TheraEditor.Wrappers
{
    ...
    public class FileWrapper : BaseWrapper
    {
        ...
        protected static void MoveUpAction(object sender, EventArgs e) { GetInstance<FileWrapper>().MoveUp(); }
        protected static void MoveDownAction(object sender, EventArgs e) { GetInstance<FileWrapper>().MoveDown(); }
