...
namespace Game.Worlds.Actors.Components.Logic
{
    ...
    public class InteractionZoneComponent : SceneComponent
    {
        public InteractionZoneComponent()
        {
            _children.Add(new ShapeComponent<IShape>());
        }
        ...
        protected ShapeComponent<IShape> ProximityCollision
        {
            get { return _children[0] as ShapeComponent<IShape>; }
        }
