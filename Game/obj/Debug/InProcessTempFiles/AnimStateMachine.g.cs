...
namespace Custom {
    ...
    public partial class AnimStateMachine : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(AnimStateMachine).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(AnimStateMachine));
        ...
        private string FindResource() {
            string[] resources = typeof(AnimStateMachine).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".AnimStateMachine.g.xaml") || resource.Equals("AnimStateMachine.g.xaml"))) {
                    return resource;
                }
            }
