...
namespace Skill
{
	namespace FbxSDK
	{		
		ref class FbxLayerElementArrayTemplateColor;		
		ref class FbxLayerElementArrayTemplateInt32;

		/** This class complements the KFbxLayerElement class.
		* \nosubgrouping
		*/		
		public ref class FbxLayerElementTemplateColor: FbxLayerElement
		{
			REF_DECLARE(FbxLayerElement,KFbxLayerElementTemplate<KFbxColor>);
			protected:
			virtual void CollectManagedMemory() override;
		internal:
			FbxLayerElementTemplateColor(KFbxLayerElementTemplate<KFbxColor>* instance) : FbxLayerElement(instance)
			{
				_Free = false;
			}
		public:
			...
			*/
			REF_PROPERTY_GET_DECLARE(FbxLayerElementArrayTemplateColor,DirectArray);				
