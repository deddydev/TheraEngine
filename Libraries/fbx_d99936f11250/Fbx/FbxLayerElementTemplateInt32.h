...

{
	...
	{		
		...
		* \nosubgrouping
		*/		
		public ref class FbxLayerElementTemplateInt32: FbxLayerElement
		{
			REF_DECLARE(FbxLayerElement,KFbxLayerElementTemplate<int>);
			protected:
			virtual void CollectManagedMemory() override;
		internal:
			FbxLayerElementTemplateInt32(KFbxLayerElementTemplate<int>* instance) : FbxLayerElement(instance)
			{
				_Free = false;
			}
		public:
			...
			*/
			REF_PROPERTY_GET_DECLARE(FbxLayerElementArrayTemplateInt32,DirectArray);				
