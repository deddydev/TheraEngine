...

{
	namespace FbxSDK
	{				
		ref class FbxLayerElementArrayTemplateTexture;		
		...
		*/
		...
		public ref class FbxLayerElementTemplateTexture : FbxLayerElement
		{
			REF_DECLARE(FbxLayerElement,KFbxLayerElementTemplate<KFbxTexture*>);
			protected:
			virtual void CollectManagedMemory() override;
		internal:
			FbxLayerElementTemplateTexture(KFbxLayerElementTemplate<KFbxTexture*>* instance) : FbxLayerElement(instance)
			{
				_Free = false;
			}
		public:
			...
			*/
			REF_PROPERTY_GET_DECLARE(FbxLayerElementArrayTemplateTexture,DirectArray);				
