...

{
	...
	{		
		...
		* \nosubgrouping
		*/		
		public ref class FbxLayerElementTemplateVector4: FbxLayerElement
		{
			REF_DECLARE(FbxLayerElement,KFbxLayerElementTemplate<KFbxVector4>);
			protected:
			virtual void CollectManagedMemory() override;
		internal:
			FbxLayerElementTemplateVector4(KFbxLayerElementTemplate<KFbxVector4>* instance) : FbxLayerElement(instance)
			{
				_Free = false;
			}
		public:
			...
			*/
			REF_PROPERTY_GET_DECLARE(FbxLayerElementArrayTemplateVector4,DirectArray);				
