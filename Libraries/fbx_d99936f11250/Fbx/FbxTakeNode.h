...
namespace Skill
{
	...
	{	
		...
		* \nosubgrouping
		*/
		public ref class FbxTakeNode : IFbxNativePointer
		{
			BASIC_CLASS_DECLARE(FbxTakeNode,KFbxTakeNode);
			INATIVEPOINTER_DECLARE(FbxTakeNode,KFbxTakeNode);
		public:
			/**
			...
			*/
			REF_PROPERTY_GET_DECLARE(FbxCurveNode,KFCurveNode);
			...
			*/
			...
			REF_PROPERTY_GET_DECLARE(FbxCurve,CameraOpticalCenterX);
			...
			*/
			enum class Error
			{
				NoCurveFound = KFbxTakeNode::eNO_CURVE_FOUND, /**< The requested FCurve was not found. */
				ErrorCount = KFbxTakeNode::eERROR_COUNT     /**< Mark the end of the EError enum.    */
			};
			...
			*/
			bool AddRotationToTranslation(FbxVector4^ rotation);
		...
		public:
			bool IsChannelAnimated(String^ group, String^ subGroup,String^ name);
			//bool IsChannelAnimated(String^ group,String^ subGroup, FbxDataType^ dataType);		
